...
* The **Client** posts a tweet to the **Web Server**, running as a [reverse proxy](https://github.com/ido777/system-design-primer-update.git#reverse-proxy-web-server)
...
* The **Search API** contacts the **Search Service**, which does the following:
    ...
    * Queries the **Search Cluster** (ie [Lucene](https://lucene.apache.org/)) for the results:
        * [Scatter gathers](https://github.com/ido777/system-design-primer-update.git#under-development) each server in the cluster to determine if there are any results for the query
